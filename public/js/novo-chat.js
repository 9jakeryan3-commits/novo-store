...
#novo-ask{position:fixed;left:50%;transform:translateX(-50%);bottom:18px;z-index:61;
 ...
 padding:5px 11px;cursor:pointer}
  ...
  #novo-ask .m.you{align-self:flex-end;max-width:min(78%,560px); color:#d3f2fb;font-weight:600;color:var(--askacc,#22d3ee);padding:2px 0}
  ...
  #novo-ask .chips button{color:var(--txt2,#9fb6d1); font-size:11.5px;padding:7px 10px;cursor:pointer;text-align:left}
  ...
  #novo-ask .quick button{flex:0 0 auto; color:#9fd8e6;font-size:11.5px;padding:6px 11px;cursor:pointer;white-space:nowrap}
  ...
  #novo-ask input:focus{border-bottom-color:var(--askacc,#22d3ee)}
  #novo-ask button.go{color:#04121a;font-weight:800;padding:0 15px;cursor:pointer;background:none;border:0;color:var(--askacc,#22d3ee);padding:0 10px;display:inline-flex;align-items:center;justify-content:center}
  ...
  #novo-ask .x{padding:5px;display:inline-flex;align-items:center;justify-content:center}
  ...
  #novo-ask button.go{padding:0 18px;height:41px;font-size:14px;background:none;border:0;color:var(--askacc,#22d3ee);padding:0 10px;display:inline-flex;align-items:center;justify-content:center}
  ...
  #novo-ask .chips button{padding:8px 13px;font-size:12px; color:var(--txt2,#9fb6d1); transition:border-color .15s,color .15s}
  ...
  @media (max-width:720px){
    ...
    #novo-ask .m.you{max-width:86%;color:var(--askacc,#22d3ee);padding:2px 0}
 ...
 margin-right:6px;white-space:nowrap}
  ...
  #novo-ask .lvl[aria-pressed="true"]{color:#0b1118;color:var(--askacc,#22d3ee)}
  ...
  #novo-ask .deeper{background:none; color:var(--txt2,#9fb6d1);font-size:11.5px;cursor:pointer;padding:4px 9px;margin:2px 0 0}
