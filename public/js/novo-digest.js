...
(function () {
  var CSS = [
    ...
    '.novo-digest .dg-sub{font-size:11px;font-weight:500;color:var(--txt3,#8f8f8f);letter-spacing:.06em;margin-left:8px;text-transform:none}',
    ...
    '.novo-digest .dg-sym + .dg-sym::before{content:"\u00b7  ";color:var(--txt3,#8f8f8f);font-weight:400}',
    '.novo-digest .dg-focus{font-size:12.5px;color:var(--txt2,#a8a8a8);font-style:italic;margin:0 0 7px}',
    '.novo-digest .dg-meta{display:block;font-family:var(--mono,ui-monospace),monospace;font-size:10.5px;letter-spacing:.05em;text-transform:uppercase;color:var(--txt3,#8f8f8f)}',
    ...
    '.novo-digest .dg-date{font-family:var(--mono,ui-monospace),monospace;font-size:10.5px;letter-spacing:.08em;text-transform:uppercase;color:var(--txt3,#8f8f8f);margin-bottom:5px}',
    ...
    '.novo-digest .dg-how{font-size:11.5px;color:var(--txt3,#8f8f8f);line-height:1.6;margin-top:14px;padding-top:12px;border-top:1px solid var(--bdr2,#242428)}',
    ...
    '.novo-digest .dg-ask:hover{border-color:var(--txt3,#8f8f8f)}'
  ].join('');
