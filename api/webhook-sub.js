...
// ── NoVo Analyst ($39 email tier) — routed by subscription metadata.tier==='analyst'. These subs have NO
...
const handler = async (req, res) => {
  ...
  if (event.type === 'checkout.session.completed' && obj.mode === 'subscription') {
    ...
    // NoVo Analyst ($39 email tier): add to the Analyst audience + send its welcome, then STOP — no license,
