...
<div style="max-width:560px;margin:0 auto;padding:30px 16px;">
  <div style="background:#1c1d21;border:1px solid #2e3036;border-radius:14px;padding:34px 32px;">
    <div style="text-align:center;">
      <img src="https://novo-options.trade/novo-logo-light.png?v=6" alt="NoVo Options Trading" width="118" style="width:118px;height:auto;display:inline-block;border:0;">
