...
module.exports = async (req, res) => {
  ...
  // SALES_PAUSED, server-side. It has always existed as a const in the marketing pages, which
  // stopped BUTTONS and not CHECKOUTS — see api/_lib/sales-gate.js.
  if (require('./_lib/sales-gate.js').blockIfPaused(req, res, 'checkout-sub')) return;
