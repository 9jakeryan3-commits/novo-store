      ...
      if (isNew) {
        try {
          await resend.emails.send({
            ...
            html: freeWelcomeHtml(process.env.DISCORD_INVITE_URL || ''),
          });
