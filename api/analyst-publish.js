...
async function _promotePublicLevels(state) {
  ...
  const buildUpsell = (u) => u === 'both'
    ...
    ? '<div style="font-size:14px;color:#eaf3ff;font-weight:700;margin-bottom:8px;">Ready for more than the taste?</div>' +
      ...
      '<div style="font-size:13.5px;color:#9fb6d1;line-height:1.55;"><b style="color:#eaf3ff">NoVo Trader</b> &mdash; the same read, live, and one click to trade the level in your own broker account within your rules. <a href="https://novo-options.trade" style="color:#34d399;font-weight:700;text-decoration:none;">See NoVo Trader &rarr;</a></div>'
    : u === 'analyst'
    ...
    : '<div style="font-size:14px;color:#eaf3ff;font-weight:700;margin-bottom:4px;">Want it raw &amp; live?</div>' +
      '<div style="font-size:13.5px;color:#9fb6d1;line-height:1.55;">This is the read. <b style="color:#eaf3ff">NoVo Trader</b> is the same read, live, with one click to trade it in your own broker account within your rules. <a href="https://novo-options.trade" style="color:#34d399;font-weight:700;text-decoration:none;">See NoVo Trader &rarr;</a></div>';
